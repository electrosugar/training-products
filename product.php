...
<form enctype="multipart/form-data" action="product.php" method="post" class="form">
    ...
    <input type="text" name="title" placeholder="<?= translateText('Product Title') ?>" value="<?= $value = isset($_POST['title'])?$_POST['title']:''; ?>"><br>
    <input type="text" name="description" placeholder="<?= translateText('Description') ?>" value="<?= $value = isset($_POST['description'])?$_POST['description']:''; ?>" id="big"><br>
    <input type="text" name="price" placeholder="<?= translateText('Price') ?> " value="<?= $value = isset($_POST['price'])?$_POST['price']:''; ?>"><br>
